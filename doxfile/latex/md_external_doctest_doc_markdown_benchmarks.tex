...
\href{https://github.com/catchorg/Catch2}{\texttt{ {\bfseries{Catch}}}} version\+: 2.\+3.\+0 (released on 2018.\+07.\+22)\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md49}{}\doxysection{Compile time benchmarks}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md49}
\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md50}{}\doxysubsection{Cost of including the header}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md50}
...
\end{longtabu}
 ...
 \hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md51}{}\doxysubsubsection{Conclusion}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md51}
\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md52}{}\doxyparagraph{doctest}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md52}
...
\end{DoxyItemize}\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md53}{}\doxyparagraph{$<$a href=\char`\"{}https\+://github.\+com/catchorg/\+Catch2\char`\"{}$>$\+Catch$<$/a$>$}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md53}
...
The reason the {\bfseries{doctest}} header is so light on compile times is because it forward declares everything and doesn\textquotesingle{}t drag any headers in the source files (except for the source file where the test runner gets implemented). This was a key design decision.\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md56}{}\doxysubsection{Cost of an assertion macro}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md56}
...
\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md57}{}\doxysubsubsection{Conclusion}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md57}
{\bfseries{doctest}}\+:
...
\end{DoxyItemize}\hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md58}{}\doxysubsection{Runtime benchmarks}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md58}
...
\end{longtabu}
 ...
 \hypertarget{md_external_doctest_doc_markdown_benchmarks_autotoc_md59}{}\doxysubsubsection{Conclusion}\label{md_external_doctest_doc_markdown_benchmarks_autotoc_md59}
